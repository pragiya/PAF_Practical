...
public class PaymentsAPI extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = pObj.insertPayment(
	...
	protected void doPut(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		Map paras = getParasMap(request);
		 String output = pObj.updatePayment(paras.get("hidPaymentIDSave").toString(),
				 			paras.get("paymentName").toString(),
				 			paras.get("aptId").toString(),
	...
	protected void doDelete(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String output = pObj.deletePayment(paras.get("payId").toString());
